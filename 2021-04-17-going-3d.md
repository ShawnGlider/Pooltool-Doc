...
In the [last](2021-03-25-pooltool-start.html) post I implemented a prototype that visualizes shots with `pygame`. But my plans are much more ambitious than visualizing shots on a pixel-art table. **My goal is to turn this simulation into an interactive, 3D game/tool**. That's what this post is about.

![before_after](assets/interface/before_after.gif){: style="width:70%; display: block; margin: 1em auto; border-radius:8px;"}
...
![panda](assets/interface/panda.gif){: style="width:70%; display: block; margin: 1em auto; border-radius:8px;"}
...
![jungle_pool](assets/interface/jungle_pool.gif){: style="width:70%; display: block; margin: 1em auto; border-radius:8px;"}
...
![camera_rotate](assets/interface/camera_rotate.gif){: style="width:70%; display: block; margin: 1em auto; border-radius:8px;"}

Next, I added a cue stick that follows the camera's orientation:

![cue](assets/interface/cue.gif){: style="width:70%; display: block; margin: 1em auto; border-radius:8px;"}
...
![stroke](assets/interface/stroke.gif){: style="width:70%; display: block; margin: 1em auto; border-radius:8px;"}
...
![pan_and_zoom](assets/interface/pan_and_zoom.gif){: style="width:70%; display: block; margin: 1em auto; border-radius:8px;"}
...
![view_mode](Assets/interface/view_mode.gif){: style="width:70%; display: block; margin: 1em auto; border-radius:8px;"}
...
![inheritance](Assets/interface/inheritance.jpeg){: style="width:70%; display: block; margin: 1em auto; border-radius:8px;"}
...
![first_shot](Assets/interface/first_shot.gif){: style="width:70%; display: block; margin: 1em auto; border-radius:8px;"}
...
![cushion_lines](Assets/interface/cushion_lines.gif){: style="width:70%; display: block; margin: 1em auto; border-radius:8px;"}

[[Browse commit]](https://github.com/ekiefl/pooltool/commit/82cdc3bac49e87f34ae6cf9803caf1fe9e581306)

It's not much better, but at least now I can start to visually sketch out the pockets. So I flipped back to when I drew this diagram for the [algorithmic theory post](2020-12-20-pooltool-alg.html):
...
![cushion_line2](Assets/interface/cushion_line2.gif){: style="width:70%; display: block; margin: 1em auto; border-radius:8px;"}
...
![problem_example](Assets/interface/problem_example.gif){: style="width:70%; display: block; margin: 1em auto; border-radius:8px;"}
...
<a id="Figure1"></a>
![problem_diagram](Assets/interface/problem_diagram.jpeg){: style="width:70%; display: block; margin: 1em auto; border-radius:8px;"}
...
![circular_segment1](Assets/interface/circular_segment1.gif){: style="width:70%; display: block; margin: 1em auto; border-radius:8px;"}

[[Browse commit](https://github.com/ekiefl/pooltool/commit/a7d4da92c4fdbd95c9b5650c15211ea31bfaccda)]

The circular segment in the middle of the table exists as an attribute of `Table`, and is properly rendered, but I haven't written the code to predict ball collisions with circular cushions. I have worked out a similar situation though, during my theoretical treatment of the [ball-pocket collision](2020-12-20-pooltool-alg.html#ball-pocket-collision-times), so I'm going to reuse that math... Essentially, one must solve a 4th order polynomial to determine if/when a ball collides with a circular cushion segment.

Well, this was surprisingly straight forward. I'd encourage you to check out the associated commit:

![circular_segment2](Assets/interface/circular_segment2.gif){: style="width:70%; display: block; margin: 1em auto; border-radius:8px;"}
...
![circular_segment3](Assets/interface/circular_segment3.gif){: style="width:70%; display: block; margin: 1em auto; border-radius:8px;"}
...
![fixed](Assets/interface/fixed.gif){: style="width:70%; display: block; margin: 1em auto; border-radius:8px;"}
...
![rendered_pockets](Assets/interface/rendered_pockets.png){: style="width:70%; display: block; margin: 1em auto; border-radius:8px;"}

[[Browse commit](https://github.com/ekiefl/pooltool/commit/749f2b35384a931892a08ff8529c63b7993ae4b0)]

Alright pockets exist and are rendered, but they do not yet interact with the balls. For this, I need to implement a collision event I have [previously theorized](2020-12-20-pooltool-alg.html#ball-pocket-collision): the ball-pocket collision. Here is the class I came up with:
...
![pockets_work](Assets/interface/pockets_work.gif){: style="width:70%; display: block; margin: 1em auto; border-radius:8px;"}
...
<video controls 
    src="YouTubeEmbedded/14.Rendered in 3D pooltool Devlog 1.mp4"
    style="width:800px; display:block; margin:0 auto;">
</video>
<p style="text-align:center; color:#666;">Rendered in 3D pooltool Devlog 1
  <a href="https://www.youtube.com/watch?v=aqjX0-A-YUw"; style="text-decoration: underline">Youtube Video</a>
</p>
